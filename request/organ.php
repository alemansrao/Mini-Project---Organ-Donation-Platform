...
if (isset($_POST['submit'])) {
    ...
    $organ = $_POST['organ'];
    $reqID = $userid . "_$organ";
    $insertQuery = "insert into requests_table values('$reqID','$userid','$email','$organ','$name','$enteredAddress',$pincode,$enteredPhone,'" . date("Y-m-j") . "');";
    if (mysqli_query($conn, $insertQuery)) {
        $msg = "Name : $name\nAddress : $address\nPincode : $pincode\nContact No : $phone";
        $mailSent = mail(getAllEmail($organ), "$organ Donor Needed Urgent", $msg);
        if ($mailSent) {
            output("All the donors has been alerted by email");
        }
        else{
...
<body>
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelect01">Select Organ</label>
                </div>
