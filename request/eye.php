...
if (isset($_POST['submit'])) {
    ...
    $reqID = $userid . "_Eye";
    $insertQuery = "insert into requests_table values('$reqID','$userid','$email','Eye','$name','$enteredAddress','$pincode',$enteredPhone,'" . date("Y-m-j") . "');";
    // echo $insertQuery;
    if (mysqli_query($conn, $insertQuery)) {
        $msg = "Name : $name\nAddress : $address\nPincode : $pincode\nContact No : $phone";
        $mailSent = mail(getAllEmail("Eye"), "Eye Donor Needed Urgent", $msg);
        if ($mailSent) {
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <div class="input-group mb-3 ">
                ...
                <input type="text" class="form-control" placeholder="eye" aria-label="Username" value="&#128065;Eye" disabled>
            </div>
            <div class="input-group mb-3 ">
                <div class="input-group-prepend">
